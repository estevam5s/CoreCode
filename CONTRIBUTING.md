# Contributing to CoreCode

Thanks for contributing.

CoreCode is a fast-moving open-source coding-agent CLI with support for multiple providers, local backends, MCP, and a terminal-first workflow. The best contributions here are focused, well-tested, and easy to review.

## Before You Start

- Search existing [issues](https://github.com/Gitlawb/corecode/issues) and [discussions](https://github.com/Gitlawb/corecode/discussions) before opening a new thread.
...
CoreCode supports multiple provider paths. If you change provider logic:
