# CoreCode for Non-Technical Users
...
CoreCode lets you use an AI coding assistant with different model providers such as:
...
After you run `corecode`, the CLI should start and wait for your prompt.
