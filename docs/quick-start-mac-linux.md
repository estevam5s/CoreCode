# CoreCode Quick Start for macOS and Linux
...
```bash
npm install -g @gitlawb/corecode@latest
```

## 7. Uninstalling CoreCode

```bash
npm uninstall -g @gitlawb/corecode
```
