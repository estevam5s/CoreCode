/**
 * CoreCode build script — bundles the TypeScript source into a single
...
const result = await Bun.build({
  ...
  define: {
    ...
    'MACRO.PACKAGE_URL': JSON.stringify('@gitlawb/corecode'),
...
console.log(`✓ Built corecode v${version} → dist/cli.mjs`)
